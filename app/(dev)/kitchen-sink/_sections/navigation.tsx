...
export async function NavigationSection() {
  ...
  return (
    ...
    >
      ...
      <Case title="Breadcrumb" note="an ordered list, and the last crumb is not a link" sources={[sources[1]]}>
        <Row label="trail">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
      ...
      <Case title="Tabs" note="switches a PANEL in place — never a route">
        <Row label="tabs">
