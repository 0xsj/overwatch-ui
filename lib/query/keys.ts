...
export const keys = {
  ...
  questions: {
    ...
    list: (workspace: string) => ["questions", workspace, "list"] as const,
  ...
  records: {
    ...
    list: (workspace: string) => ["research-records", workspace, "list"] as const,
  ...
  connections: {
    ...
    list: (workspace: string) => ["research-connections", workspace, "list"] as const,
